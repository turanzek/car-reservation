sap.ui.define([
	...
	return BaseController.extend("int.training.reservation.controller.Master", {
		...
		onSearch : function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("Model", FilterOperator.Contains, sQuery)];
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this._pViewSettingsDialog) {
				this._pViewSettingsDialog = Fragment.load({
					...
					name: "int.training.reservation.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Reserved":
						aFilters.push(new Filter("Reserved", FilterOperator.NE, null));
						break;
					case "NotReserved":
						aFilters.push(new Filter("Reserved", FilterOperator.EQ, null));
						break;
					default:
					break;
				}
		...
		_applyGrouper: function (oEvent) {
			...
			if (mParams.groupItem) {
				// mParams.groupItem.getKey() === "Model" ?
					// sPath = "VehicleSet/" + mParams.groupItem.getKey() : sPath = mParams.groupItem.getKey();
		...
		_showDetail : function (oItem) {
			...
			this.getRouter().navTo("object", {
				objectId : oItem.getBindingContext().getProperty("Plate")
			}, bReplace);
		},
